//HintName: DarkLink.RoslynHelpers.AttributeGenerator.Docs.g.cs
// <auto-generated />
#nullable enable
...
namespace DarkLink.RoslynHelpers.AttributeGenerator
{
    partial record Docs
    {
        public const string ATTRIBUTE_NAME = "DarkLink.RoslynHelpers.AttributeGenerator.Docs";

        public static void AddTo(IncrementalGeneratorPostInitializationContext context)
        {
            const string hintName = "DarkLink.RoslynHelpers.AttributeGenerator.Docs.g.cs";
...
";
        ...
        public static Docs From(AttributeData data)
        {
        ...
        public static bool TryFrom(AttributeData data, [NotNullWhen(true)] out Docs? parsedData)
        {
            try
            {
        ...
        public static IncrementalValuesProvider<T> Find<T>(
            ...
            Func<GeneratorAttributeSyntaxContext, IReadOnlyList<(AttributeData AttributeData, Docs ParsedData)>, CancellationToken, T> transform)
            => syntaxValueProvider.ForAttributeWithMetadataName(
                ATTRIBUTE_NAME,
                predicate,
                (context, cancellationToken) =>
                {
                    var attributes = (IReadOnlyList<(AttributeData, Docs)>) context.Attributes
                        .Select(data =>
                        {
        ...
        public static IncrementalValuesProvider<T> Find<T>(
            SyntaxValueProvider syntaxValueProvider,
            Func<SyntaxNode, CancellationToken, bool> predicate,
            Func<GeneratorAttributeSyntaxContext, IReadOnlyList<Docs>, CancellationToken, T> transform)
            => Find(
                syntaxValueProvider,
                predicate,
